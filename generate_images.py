...
def main():
	...
	parser.add_argument('--model_path', type=str, default='/content/drive/My Drive/Data/Models/latest_model_face_temp.ckpt',
	...
	parser.add_argument('--caption_thought_vectors', type=str, default='/content/drive/My Drive/demo_caption_vectors.hdf5',
	...
	print(h.keys())
	caption_vectors = h['vectors'][:]
	with open("/content/drive/My Drive/demo_images.txt") as f:
	...
	for cn in range(0, len(caption_vectors)):
		...
		caption_image_dic[ cn ][0] = skimage.transform.resize(caption_image_dic[ cn ][0], (256, 256))
		scipy.misc.imsave( '/content/drive/My Drive/Data/Demo/'+image_name[cn] , caption_image_dic[ cn ][0])
